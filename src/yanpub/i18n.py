...
class I18nManager:
    ...
    def export_translations(self, lang: str, output_path: Path) -> None:
        ...
        with open(output_path, "w", encoding="utf-8") as f:
            yaml.dump(dict(messages), f, allow_unicode=True, default_flow_style=False, sort_keys=True)
    ...
    def translate_doc(self, doc_data: dict, target_lang: str) -> dict:
        ...
        # 需要翻译的文本字段名
        translatable_fields = {
            "name", "description", "site_name", "site_description",
            "category", "concept", "comment_syntax", "repl_prompt",
        }
