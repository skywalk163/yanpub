...
from .bench_history import (  # noqa: F401
    BENCH_HISTORY_DIR,
    BenchSnapshot,
    BenchHistory,
    RegressionInfo,
...
def __getattr__(name):
    _moved = {
        "BENCH_HISTORY_DIR", "BenchSnapshot", "BenchHistory",
        "RegressionInfo", "REGRESSION_THRESHOLD", "RegressionDetector",
    }
    if name in _moved:
        import importlib
        mod = importlib.import_module(".bench_history", __name__)
